...
class Data {
  final int id;
  final AddAddressAttributes attributes;
  ...
  factory Data.fromMap(Map<String, dynamic> json) => Data(
        id: json["id"],
        attributes: AddAddressAttributes.fromMap(json["attributes"]),
      );
...
class AddAddressAttributes {
  ...
  factory AddAddressAttributes.fromJson(String str) =>
      AddAddressAttributes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AddAddressAttributes.fromMap(Map<String, dynamic> json) => AddAddressAttributes(
        name: json["name"],
