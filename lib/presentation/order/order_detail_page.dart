...
class _OrderDetailPageState extends State<OrderDetailPage> {
  ...
  Widget build(BuildContext context) {
    int totalItem = 0;
    int item = 0;
    for (var element in widget.buyerOrder.attributes.itemProducts) {
      ...
      body: ListView(
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemCount: widget.buyerOrder.attributes.itemProducts.length,
            itemBuilder: (context, index) => OrderProductTile(
              data: widget.buyerOrder.attributes.itemProducts[index],
            ),
          ),
          const SpaceHeight(24.0),
          const Text(
